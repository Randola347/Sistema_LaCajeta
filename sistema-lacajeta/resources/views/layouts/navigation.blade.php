        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('deudores.index')" :active="request()->routeIs('deudores.*')">
                        {{ __('Deudores') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('ventas.index')" :active="request()->routeIs('ventas.*')">
                        <span class="inline-flex items-center gap-2">
                            ...
                            @endphp
                            @if($cartCount > 0)
                                <span class="text-xs px-2 py-0.5 rounded-full bg-purple-600 text-white">
                                    {{ (int)$cartCount }}
                                </span>
                            @endif
                        </span>
